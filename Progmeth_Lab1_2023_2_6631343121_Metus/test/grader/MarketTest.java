...
public class MarketTest {
    ...
    void testConstructor(){
        Market market1 = new Market("Samyan");
        Market market2 = new Market("Chiang Mai");
        assertEquals("Samyan",market1.getName());
        assertEquals(new ArrayList<Food>(),market1.getFoods());
        assertEquals(new ArrayList<Potion>(),market1.getPotions());

        assertEquals("Chiang Mai",market2.getName());
    ...
    void testSetName(){
        ...
        market1.setName("Osaka");
        market2.setName("Hokkaido");
        assertEquals("Osaka",market1.getName());
        assertEquals("Hokkaido",market2.getName());
    }
    @Test
    void testSetFood(){
