...
public class PlayerTest {
    ...
    void testSetPotions() {
        try {
            Player player1 = new Player("player1", new Status(4, 1, 2, 2));

            Potion potion1 = new Potion("Potion1", 3,new Status(4, 1, 2, 5));
            Potion potion2 = new Potion("Potion2",7, new Status(5, 2, 4, 6));

            Potion potion11 = new Potion("Potion1", 3,new Status(4, 1, 2, 5));
            Potion potion22 = new Potion("Potion2", 7,new Status(5, 2, 4, 6));

            ArrayList<Potion> potions = new ArrayList<Potion>();
            ArrayList<Potion> potions2 = new ArrayList<Potion>();

            assertEquals(potions, player1.getPotions());
            potions.add(potion1);
            potions2.add(potion11);
            player1.setPotions(potions);
            assertEquals(potions2, player1.getPotions());
